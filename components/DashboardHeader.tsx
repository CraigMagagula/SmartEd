...
import { CompassIcon, SettingsIcon, UserIcon, LogOutIcon, RocketIcon } from './icons';
...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({ onSignOut }) => {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-sm border-b border-slate-200 px-6 py-3">
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
            ...
            <HeaderButton onClick={onSignOut} className="bg-red-600 text-black hover:bg-grey-900">
