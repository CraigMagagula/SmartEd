...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 5a3 3 0 1 0-5.993.129" /><path d="M12 5a3 3 0 1 0 5.993.129" /><path d="M12 19a3 3 0 1 0-5.993-.129" /><path d="M12 19a3 3 0 1 0 5.993-.129" /><path d="M12 12a3 3 0 1 0-5.993-.129" /><path d="M12 12a3 3 0 1 0 5.993-.129" /><path d="M19 12a3 3 0 1 0-5.993-.129" /><path d="M5 12a3 3 0 1 0 5.993.129" /><path d="M9.129 6.871A3.001 3.001 0 0 0 9.129 5" /><path d="M14.87 6.871A3.001 3.001 0 0 0 14.87 5" /><path d="M9.129 17.129A3.001 3.001 0 0 0 9.129 19" /><path d="M14.87 17.129A3.001 3.001 0 0 0 14.87 19" /><path d="M6.1 9.129A3.001 3.001 0 0 0 5 9.129" /><path d="M17.9 9.129A3.001 3.001 0 0 0 19 9.129" /><path d="M6.1 14.87A3.001 3.001 0 0 0 5 14.87" /><path d="M17.9 14.87A3.001 3.001 0 0 0 19 14.87" />
  </svg>
);
...
export const LoadingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} className={`animate-spin ${props.className}`} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RocketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.09-3.1a2.18 2.18 0 0 0-3.19-.09Z"/><path d="M12 13.01V13a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2ZM12 13h4.01"/><path d="M17.5 16.5c1.5 1.26 2 5 2 5s-3.74-.5-5-2c-.71-.84-.7-2.3-.09-3.1a2.18 2.18 0 0 1 3.19-.09Z"/><path d="M12.5 2.5a2.18 2.18 0 0 1 3.19.09c.6.8.61 2.26-.09 3.1-1.26 1.5-5 2-5 2s.5-3.74 2-5Z"/><path d="M12 2.49V2a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2ZM12 2H7.99"/><path d="M6.5 7.5c-1.5-1.26-2-5-2-5S8.24 3 9.5 4.5c.71.84.7 2.3.09 3.1a2.18 2.18 0 0 1-3.19.09Z"/>
    </svg>
);
...
export const SmartEdIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect width="48" height="48" rx="12" fill="url(#paint0_linear_SE)"/>
    <path d="M20.5 14C20.5 11.2386 18.2614 9 15.5 9C12.7386 9 10.5 11.2386 10.5 14V39H20.5V14Z" fill="white" fillOpacity="0.8"/>
    <path d="M34 22C34 20.3431 32.6569 19 31 19C29.3431 19 28 20.3431 28 22V39H34V22Z" fill="white"/>
    <defs>
      <linearGradient id="paint0_linear_SE" x1="0" y1="0" x2="48" y2="48" gradientUnits="userSpaceOnUse">
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m12 3-1.91 3.82-3.82 1.91 3.82 1.91L12 14.46l1.91-3.82 3.82-1.91-3.82-1.91L12 3z"/>
...
export const ClipboardPasteIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M9 2H15" />
    <path d="M10 6v2a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2V6" />
    <path d="M10 13h4" />
    <path d="M12 11v4" />
  </svg>
);
...
export const ListTreeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21 12h-8" /><path d="M21 6H8" /><path d="M21 18h-8" /><path d="M3 12v.01" /><path d="M3 6v.01" /><path d="M3 18v.01" />
  </svg>
);
...
export const SitemapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M7 15h4" /><path d="M15 7h4" /><path d="M7 9v1" /><path d="M15 11v1" />
    <path d="M11 15v4" /><path d="M9 7v4" />
  </svg>
);

export const FileQuestionIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
